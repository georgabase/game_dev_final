...
public class FiringScript2 : MonoBehaviour
{
	...
	public void Attack(bool isEnemy)
	{
		if (CanAttack)
		{
			...
			var playerScript = GameObject.FindWithTag ("Player2").GetComponent<PlatformerCharacter2DTWO>();

			//var shotTransform;
			if (playerScript.m_FacingRight2) {
				// Create a new shot
				shotTransform = Instantiate (shotPrefabRight) as Transform;
			} else if (!playerScript.m_FacingRight2) {shotTransform = Instantiate (shotPrefabLeft) as Transform;
			}
